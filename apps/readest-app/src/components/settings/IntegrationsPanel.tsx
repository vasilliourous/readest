...
const IntegrationsPanel: React.FC = () => {
  ...
  // Third-party cloud sync is available to all users — no premium gating.
  ...
  useEffect(() => {
    ...
    // Cloud-sync sub-pages are always accessible.
      ...
      <div className='w-full' data-setting-id='settings.integrations.cloudSync'>
        ...
        <div className='card eink-bordered border-base-200 bg-base-100 overflow-hidden border'>
          ...
          >
            ...
            />
            {/* Third-party providers: every row is accessible to all users. */}
